...
void Parallel_vector_dot_product(double local_x[], double local_y[], 
      double* local_dot_product, int local_n);
...
int main(void) {
   ...
   Parallel_vector_dot_product(local_x, local_y, &local_dot_product, local_n);
   ...
   if (my_rank == 0) {
      ...
      printf("Dot product calculation took %f seconds\n", elapsed);
   }
